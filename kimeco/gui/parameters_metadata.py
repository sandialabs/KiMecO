...
PARAMETER_DESCRIPTIONS = {
    ...
    "nm_final_fatol": "Final NM function tolerance",
    "nm_final_xatol": "Final NM parameter tolerance",
    "nm_final_maxiter": "Final NM maximum iterations",
    "nm_final_maxfev": "Final NM max function evaluations",
    "nm_final_adaptive": "Enable adaptive final NM",
    ...
    "cpu_kin": "CPU cores per master equation job",
    "mem_kin": "Memory (MB) per master equation job",
    "cpu_sim": "CPU cores per simulation job",
    "mem_sim": "Memory (MB) per simulation job",
    "mem_hlp": "Memory (MB) per helper job",
    "max_mem": "Max memory (MB) per generation",
    "max_cpu": "Max CPU cores per generation",
    ...
    "n_elem": "Number of elements per generation",
...
PARAMETER_CATEGORIES = {
    ...
    "nm_final_fatol": "Nelder-Mead",
    "nm_final_xatol": "Nelder-Mead",
    "nm_final_maxiter": "Nelder-Mead",
    "nm_final_maxfev": "Nelder-Mead",
    "nm_final_adaptive": "Nelder-Mead",
